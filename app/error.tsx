...
/**
 * Root error boundary. Never renders `error.message` or `error.stack` to
 * the user — those can contain Supabase/Postgres internals depending on
 * where the throw originated. Only a generic, localized message is shown.
 * The raw error is still logged to the console for diagnosability during
 * development / via browser error monitoring, never sent to the UI.
 */
