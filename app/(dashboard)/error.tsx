...
/**
 * Catches errors thrown by DashboardLayout itself (e.g. the
 * getCurrentProfile() call failing) — app/(dashboard)/app/error.tsx only
 * catches errors from pages/layouts nested BELOW it, not from its own
 * parent layout, so this boundary exists specifically to cover that gap.
 */
